 ...
 */
class GestureConflictPage02 extends StatefulWidget {
  const GestureConflictPage02({Key? key}) : super(key: key);

  @override
  State<GestureConflictPage02> createState() => _GestureConflictPage02State();
}

class _GestureConflictPage02State extends State<GestureConflictPage02> {
  double _left = 0.0;
