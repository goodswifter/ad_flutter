...
import 'package:flutter_combat/widgets/sliver_persistent_header_to_box.dart';

class SliverPersistentHeaderToBoxPage extends StatelessWidget {
  const SliverPersistentHeaderToBoxPage({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('自定义SliverPersistentHeader')),
