...
class _SearchProductResultPageState extends State<SearchProductResultPage> {
  ...
  void _onRefresh() async {
    ...
    if (Global.profile.user != null) {
      goodpricenotinteresteduids = await imHelper
  ...
  void _onLoading() async {
    ...
    final moredata = await gpService.searchProduct(ordertype, citycode,
        goodPiceModels.length, isAllCity, widget.content, errorCallBack);
