...
class _CreateOrderPageState extends State<CreateOrder> {
  ...
  _getGoodPriceSpecsList() async {
    skuSpecsList =
        await _gpService.getProductSpecsList(widget.goodPiceModel.goodpriceid);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(widget.goodPiceModel.title,
      ...
      if (_selectIndexValue1 != "") {
        for (int i = 0; i < skuSpecsList.length; i++) {
          ...
          if (_selectIndexValue1 == temJson[0]["value"].toString()) {
            ...
            ;
            _saleprice = skuSpecsList[i].cost *
            ...
            Expanded(
              child: TextButton(
                  ...
                  onPressed: () async {
                    ...
                    if (speaceName != "") {
                      speaceName =
                          speaceName.substring(0, speaceName.length - 1);
                    }
