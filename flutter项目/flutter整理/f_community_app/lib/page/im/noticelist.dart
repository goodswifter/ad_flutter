...
class _NoticeListState extends State<NoticeList> {
  ...
  getNoticelList() async {
    ...
    List<CommentReply>? temcommreplys =
        await imHelper.getCommentReplys(0, 5000);
    if (temcommreplys != null) commentReplys = commentReplys + temcommreplys;
        ...
        GestureDetector(
          ...
          onTap: () async {
            ...
            if (item.type == ReplyMsgType.commentmsg.toString() ||
              ...
              Navigator.pushNamed(context, '/ActivityInfo', arguments: {
                "actid": item.actid,
                "isShowComment": true,
              ...
              GoodPiceModel? goodprice =
                  await gpservice.getGoodPriceInfo(item.actid!);
              if (goodprice != null) {
