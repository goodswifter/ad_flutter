...
class _ThumbUpListState extends State<ThumbUpList> {
  ...
  void initState() {
    ...
    _replyNoticeBloc.add(readed(Global.profile.user!,
        replyMsgType: ReplyMsgType.newliked)); //全部点赞都已读
  }
              ...
              children: <Widget>[
                GestureDetector(
                  ...
                  onTap: () async {
                    ...
                    if (item.liketype == 2) {
                      Navigator.pushNamed(context, '/EvaluateListInActivity',
                          arguments: {"actid": item.contentid});
                    }
                    ...
                    if (item.liketype == 7) {
                      ...
                      GoodPiceModel? goodprice =
                          await gpservice.getGoodPriceInfo(item.contentid!);
                      if (goodprice != null) {
