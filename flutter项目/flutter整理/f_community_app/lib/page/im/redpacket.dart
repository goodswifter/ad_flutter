...
class _RedPacketState extends State<RedPacket> {
  ...
  TextEditingController _textRedNumController = TextEditingController();
  TextEditingController _textRedAmountController = TextEditingController();
  TextEditingController _textRedContentController = TextEditingController();
