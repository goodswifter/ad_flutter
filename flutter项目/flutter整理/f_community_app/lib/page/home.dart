...
class _HomePageState extends State<HomePage>
  ...
  MyTabBarView _buildTabView() {
    return MyTabBarView(controller: _tabController,
        ...
        child: InkWell(
          child: Column(
            children: <Widget>[
              ...
              Container(
                margin:
                    EdgeInsets.only(left: widget.title.length >= 3 ? 17 : 10),
                alignment: Alignment.bottomLeft,
                child: Text(_itemindex == _currentIndex ? "—" : "",
                    style: TextStyle(
                        fontSize: _itemindex == _currentIndex ? 16 : 14,
                  ...
                  Navigator.pushNamed(context, '/ListViewProvince',
                    ...
                    if (value != null) {
                      if (Global.profile.locationCode !=
                        ...
                        _cityActivityDataBloc
                            .add(Refreshed(Global.profile.locationCode));
                        Global.saveProfile();
                      }
