...
class _SearchActivityResultPageState extends State<SearchActivityResultPage> {
  ...
  void _onLoading() async {
    ...
    final moredata = await _activityService.searchActivity(ordertype, citycode,
        activitys.length, isAllCity, widget.content, errorCallBack);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: SmartRefresher(
            ...
            child: activitys.length == 0 &&
                    _refreshController.headerStatus == RefreshStatus.completed
                ? widgetMessage
                : ListView(
                    addAutomaticKeepAlives: true, children: buildContent())));
  }
