...
class _IssuedActivityState extends State<IssuedActivity> {
                ...
                setState(() {
                  ...
                  if (_locationResult != null) {
                    if (result["longitude"] != "" && result["adCode"] != "") {
                      ...
                      Navigator.pushNamed(context, '/MapLocationPicker',
                          arguments: {
                        ...
                        if (value != null) {
                          setState(() {
                            ...
                            _city =
                                CommonUtil.getCityNameByGaoDe(value["adCode"]);
  ...
  Widget buildGridView() {
    List<Widget> lists = List.generate(
        _images.length + oldImageCount == _imageMax
            ...
            : _images.length + 1 + oldImageCount, (index) {
      if (index == (_images.length + oldImageCount) && index < _imageMax) {
        ...
        Widget tem = const SizedBox.shrink();
    ...
    return Container(
      ...
      child: GridView.count(
          shrinkWrap: true, // 自动高
          physics: const NeverScrollableScrollPhysics(), // 添加
          ...
          onPressed: () async {
            try {
              if (_isButtonEnable) {
                ...
                if (activity != null) {
                  Navigator.popAndPushNamed(context, '/ActivityInfo',
  ...
  loadingBlockPuzzle(BuildContext context,
      {barrierDismissible = true, int? commentid, int? touid, User? touser}) {
    showDialog<Null>(
      context: context,
      ...
      builder: (BuildContext context) {
        return BlockPuzzleCaptchaPage(
          onSuccess: (v) async {
            ...
            if (activity != null) {
              Navigator.popAndPushNamed(this.context, '/ActivityInfo',
                  arguments: {"actid": activity.actid});
            }
          },
          onFail: () {},
