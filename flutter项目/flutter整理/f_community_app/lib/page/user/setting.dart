...
import 'package:f_community_app/util/networkmanager_util.dart';
...
class _SettingState extends State<Setting> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title:
            Text('账号相关', style: TextStyle(color: Colors.black, fontSize: 16)),
        centerTitle: true,
      ),
      body: Container(
  ...
  Future<void> telCustomerCare(String vcode) async {
    ...
    GroupRelation? groupRelation =
        await imhelper.getGroupRelationByGroupid(uid, timeline_id);
