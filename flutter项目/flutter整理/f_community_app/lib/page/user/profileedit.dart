              ...
              children: <Widget>[
                ...
                Container(
                  ...
                  child: ListTile(
                    onTap: () {
                      //类型等于1是修改昵称
                      Navigator.pushNamed(context, '/NameAndSignature',
                          arguments: {
                            "type": "1",
                ...
                Container(
                  ...
                  child: ListTile(
                    onTap: () {
                      Navigator.pushNamed(context, '/ListViewProvince',
                        ...
                        if (value != null) {
                          ...
                          _bloc.add(UpdateUserLocationPressed(
                              user: user,
                    ...
                    onTap: () {
                      showDialog(
                        ...
                        if (Global.profile.user!.sex != onValue &&
                            onValue != null) {
                          _bloc.add(UpdateUserSexPressed(
                              user: Global.profile.user!, sex: onValue));
                        }
                      });
                    },
                    title: Container(
                    ...
                    title: Container(
                      child: Row(
                        ...
                        children: <Widget>[
                          ...
                          Expanded(
                            child: Text(
                                user.signature != null ? user.signature : "",
                                style: TextStyle(
                                    color: Colors.black45,
                                    fontSize: contentfontsize),
  ...
  void showDefaultYearPicker(BuildContext context) async {
    ...
    DateTime? date = await showDatePicker(
      ...
      if (Global.profile.user!.birthday != val.toString().substring(0, 10)) {
        _bloc.add(UpdateUserBirthdayPressed(
            user: user, birthday: val.toString().substring(0, 10)));
      }
    }).catchError((err) {
      //print(err);
    });
      ...
      if (imageFile != null) {
        ...
        if (croppedFile != null) {
          ...
          if (ossimagpath.isNotEmpty) {
            _bloc.add(UpdateImagePressed(
                user: user, imgpath: ossimagpath, serverimgpath: serverossimg));
          }
        }
      }
    });
    ...
    showModalBottomSheet<String>(
      ...
      if (value != null && value != "") {
        ...
        bool ret = await userService.updateVoice(
            Global.profile.user!.token!, Global.profile.user!.uid, value,
