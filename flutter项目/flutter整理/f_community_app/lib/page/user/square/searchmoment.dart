...
import 'package:f_community_app/service/imservice.dart';
...
class _SearchMomentState extends State<SearchMoment> {
  ...
  final SearchBarController<SearchResult> _searchBarController =
      SearchBarController();
...
//          emptyWidget: Text('111111'),
          ...
          onCancelled: () {
            ...
            Navigator.pushNamed(context, '/SearchMomentResultPage',
                ...
                ListTile(
                  ...
                  onTap: () {
                    Navigator.pushReplacementNamed(
                        context, '/SearchMomentResultPage',
    ...
    if (searchResults != null && searchResults.length > 0) {
      for (int i = 0; i < searchResults.length; i++) {
        hotSearchs.add(InkWell(
          ...
          onTap: () {
            Navigator.pushReplacementNamed(context, '/SearchMomentResultPage',
