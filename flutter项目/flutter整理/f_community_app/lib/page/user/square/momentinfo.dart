    ...
    if (_moment != null) {
      ...
      if (Global.profile.user != null) {
        await imhelper.selBugAndSuggestState(
            widget.momentid, Global.profile.user!.uid, 2, (List<String> actid) {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
          ...
          title:
              Text('动态', style: TextStyle(color: Colors.black, fontSize: 16)),
          centerTitle: true,
          actions: [
            _moment != null
                ? Padding(
                                ...
                                onPressed: () async {
                                  ...
                                  if (_isCommentLike) {
                                    ...
                                    if (v.likeuid == 0) {
                                      ...
                                      bool ret =
                                          await imService.delMomentCommentLike(
                                              v.commentid!,
                                              Global.profile.user!.uid,
                                              Global.profile.user!.token!,
                                              v.user!.uid,
                            ...
                            PopupMenuItem(
                              child: InkWell(
                                ...
                                onTap: () async {
                                  ...
                                  if (ret) {
                                    listComments =
                                        await imService.getMomentCommentList(
                                            widget.momentid, errorCallBack);
                    ...
                    onPressed: () async {
                      if (_message.isNotEmpty) {
                        if (commentid == 0) {
                          Navigator.pop(context);
                          int retcommentid =
                              await imService.updateMomentMessage(
                                  widget.momentid,
                                  Global.profile.user!.uid,
                                  Global.profile.user!.token!,
                                  touid,
                          ...
                          Navigator.pop(context);
                          int temreplyid =
                              await imService.updateMomentCommentReply(
                                  commentid,
                                  widget.momentid,
                                  Global.profile.user!.uid,
                                  Global.profile.user!.token!,
