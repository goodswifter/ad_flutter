...
import 'package:f_community_app/common/iconfont.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title:
            Text('活动分享', style: TextStyle(color: Colors.black, fontSize: 16)),
        centerTitle: true,
        actions: [
          WXShareView(
            icon: Padding(
    ...
    return GestureDetector(
      onTap: () {
        Navigator.pushNamed(context, '/ActivityInfo',
            arguments: {"actid": userShared.contentid}).then((val) {});
      },
      child: Card(
        child: Column(
            ...
            Container(
              ...
              child: Row(
                ...
                children: <Widget>[
                  CircleAvatar(
                    backgroundImage:
                        NetworkImage(userShared.fromprofilepicture!),
                    radius: 9,
                    // maxRadius: 40.0,
                  ),
                  Expanded(
