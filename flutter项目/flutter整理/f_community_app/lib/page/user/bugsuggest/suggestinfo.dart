...
class _SuggestInfoState extends State<SuggestInfo> {
  ...
  getSuggest() async {
    _suggest = await imService.getSuggestInfo(Global.profile.user!.uid,
        Global.profile.user!.token!, widget.suggestid, errorCallBack);
    if (_suggest != null) {
      ...
      await imhelper.selBugAndSuggestState(
          widget.suggestid, Global.profile.user!.uid, 1, (List<String> actid) {
        ...
        children: <Widget>[
          ...
          Expanded(
            child: Column(
              ...
              children: <Widget>[
                Text(_suggest!.user!.username,
                    style: TextStyle(
                        color: Colors.black87,
                        fontSize: 16,
                        fontWeight: FontWeight.bold)),
                Text(CommonUtil.datetimeFormat(
            ...
            child: Column(
              ...
              children: <Widget>[
                Row(
                  ...
                  children: <Widget>[
                    Text('全部留言(${comments.length.toString()})',
                        style: TextStyle(
                            color: Colors.black87,
                            fontSize: 14,
                            fontWeight: FontWeight.bold)),
                                ...
                                onPressed: () async {
                                  if (_isCommentLike) {
                                    ...
                                    if (v.likeuid == 0) {
                                      ...
                                      bool ret =
                                          await imService.delSuggestCommentLike(
                                              v.commentid!,
                                              Global.profile.user!.uid,
                                              Global.profile.user!.token!,
                                              v.user!.uid,
                            ...
                            PopupMenuItem(
                              child: InkWell(
                                ...
                                onTap: () async {
                                  ...
                                  if (ret) {
                                    listComments =
                                        await imService.getSuggestCommentList(
                                            widget.suggestid,
                                            Global.profile.user!.uid,
                                            errorCallBack);
                                    if (listComments != null &&
                                      ...
                                      listComments =
                                          sortComment(listComments, _ordertype);
                                    }
                                    setState(() {});
                                  }
                                  Navigator.pop(context);
                    ...
                    onPressed: () async {
                      if (_message.isNotEmpty) {
                        if (commentid == 0) {
                          Navigator.pop(context);
                          int retcommentid =
                              await imService.updateSuggestMessage(
                                  widget.suggestid,
                                  Global.profile.user!.uid,
                                  Global.profile.user!.token!,
                                  touid,
                          ...
                          Navigator.pop(context);
                          int temreplyid =
                              await imService.updateSuggestCommentReply(
                                  commentid,
                                  widget.suggestid,
                                  Global.profile.user!.uid,
                                  Global.profile.user!.token!,
          ...
          child: Column(
            children: <Widget>[
              ...
              Container(
                  ...
                  margin:
                      EdgeInsets.only(top: 5, bottom: 5, right: 5, left: 40),
                  child: RichText(
          ...
          return BlockPuzzleCaptchaPage(
            onSuccess: (v) async {
              if (commentid == 0) {
                ...
                listComments.insert(
                    0,
                    Comment(retcommentid, widget.suggestid, Global.profile.user,
                        _message, 0, CommonUtil.getTime(), 0));
                setState(() {});
              } else {
