...
class _IndexPageState extends State<IndexPage> {
  ...
  CommonJSONService _commonJSONService = CommonJSONService();
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      bottomNavigationBar:
          BlocBuilder<ImBloc, ImState>(builder: (context, state) {
        int newImMode = 0;
        int newActivity = 0;
        ...
        return BottomNavigationBar(
          ...
          items: [
            BottomNavigationBarItem(
                icon:
                    Icon(IconFont.icon_shouye, size: 23, color: Colors.black45),
                activeIcon: Icon(IconFont.icon_shouye1,
                    color: Global.profile.backColor, size: 23),
                label: '首页'),
            BottomNavigationBarItem(
              icon: Icon(IconFont.icon_icon_shangcheng_xian,
                  color: Colors.black45, size: 23),
              activeIcon: Icon(IconFont.icon_icon_shangcheng_mian,
                  color: Global.profile.backColor, size: 23),
              label: '活动',
            ),
            BottomNavigationBarItem(
              ...
              activeIcon: Icon(IconFont.icon_yumaobi_tianchong,
                  color: Global.profile.backColor, size: 23),
              label: '动态',
            ),
            BottomNavigationBarItem(
              icon: newImMode > 0 && Global.profile.user != null
                  ? Badge(
                      ...
                      child: Icon(IconFont.icon_xiaoxixuanzhong01,
                          color: Colors.black45, size: 23))
                  : Icon(IconFont.icon_xiaoxixuanzhong01,
                      color: Colors.black45, size: 23),
              activeIcon: Icon(IconFont.icon_xiaoxi,
                  color: Global.profile.backColor, size: 23),
              label: '消息',
            ),
            BottomNavigationBarItem(
              icon: newActivity > 0 && Global.profile.user != null
                  ? Badge(
                      ...
                      badgeContent: Text(
                          ...
                          style: TextStyle(fontSize: 9, color: Colors.white)),
                      child: Icon(IconFont.icon_wode1,
                          color: Colors.black45, size: 23))
                  : Icon(IconFont.icon_wode1, color: Colors.black45, size: 23),
              activeIcon: Icon(IconFont.icon_navbar_wode_xuanzhong,
                  color: Global.profile.backColor, size: 23),
              label: '我的',
            ),
          ],
