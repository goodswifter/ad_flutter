...
import 'dart:isolate';
import 'dart:ui';
import 'package:f_community_app/util/showmessage_util.dart';
...
class AppupdateUtil {
  ...
  static _TaskInfo _downloadinfo = _TaskInfo();
  ...
  static void downloadCallback(
    ...
    final SendPort? send =
        IsolateNameServer.lookupPortByName('flutter_mycommunity_app');
