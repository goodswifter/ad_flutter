...
import 'package:f_community_app/service/aliyun.dart';
import '../../global.dart';
...
class CommonUtil {
  ...
  //图片压缩并上传阿里云oss 返回url
  static Future<String> upLoadImage(File file, SecurityToken securityToken,
      AliyunService aliyunService) async {
    String ossurl = "";
    ...
    ossurl = await aliyunService.uploadImage(
        securityToken, file.path, '${md5name}.png', Global.profile.user!.uid);
    return ossurl;
  }
}
