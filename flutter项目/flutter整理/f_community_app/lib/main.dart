  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
        ...
        child:RefreshConfiguration(
            headerBuilder: () => const MaterialClassicHeader(distance: 100, ),// 配置默认头部指示器,假如你每个页面的头部指示器都一样的话,你需要设置这个
            footerBuilder:  () => const ClassicFooter( loadStyle: LoadStyle.ShowWhenLoading),        // 配置默认底部指示器
