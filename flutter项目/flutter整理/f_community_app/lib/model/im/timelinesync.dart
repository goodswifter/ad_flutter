...
class TimeLineSync {
  ...
  Map<String, dynamic> toMap() {
    ...
    data['serdername'] =
        this.senderUser == null ? this.serdername : this.senderUser!.username;
...
//    User user = User.fromJson(data['sender'] as Map<String, dynamic>);
    ...
    this.serdername =
        (this.senderUser!.username == null ? "" : this.senderUser!.username);
    this.serderpicture = (this.senderUser!.profilepicture == null
        ? ""
        : this.senderUser!.profilepicture);
    this.content = data['content'];
    this.contenttype = data['contenttype'];
