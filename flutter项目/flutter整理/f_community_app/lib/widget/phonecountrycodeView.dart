...
import 'package:f_community_app/service/commonjson.dart';
...
class PhoneCountryCodeViewState extends State<PhoneCountryCodeView> {
  CommonJSONService _commonJSONController = CommonJSONService();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title:
            Text('国家和地区', style: TextStyle(color: Colors.black, fontSize: 16)),
        centerTitle: true,
      ),
      body: Stack(
        children: <Widget>[
...
class PhoneCountryCodeEntity {
  ...
  PhoneCountryCodeEntity(
      {this.code = 0, required this.data, this.message = ""});
...
class PhoneCountryCodeDataListdata {
  ...
  PhoneCountryCodeDataListdata(
      {this.code = "", this.name = "", this.id = 0, this.groupCode = ""});
