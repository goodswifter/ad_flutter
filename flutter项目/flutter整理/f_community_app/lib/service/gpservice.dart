...
class GPService {
  ...
  Future<List<SearchResult>> hotsearchProduct() async {
    ...
    await NetUtil.getInstance().get("/grouppurchase/hotsearchProduct",
  ...
  Future<List<SearchResult>> getRecommendSearchProduct(
    ...
    await NetUtil.getInstance()
        .post(formData, "/grouppurchase/getRecommendSearchProduct",
            (Map<String, dynamic> data) {
      if (data["data"] != null) {
        for (int i = 0; i < data["data"].length; i++) {
          SearchResult searchResult = SearchResult.fromJson(data["data"][i]);
  ...
  Future<bool> updateCollection(
      int productid, int uid, String token, Function errorCallBack) async {
    bool isUpdate = false;
    FormData formData = FormData.fromMap({
      "token": token,
      "productid": productid,
    ...
    await NetUtil.getInstance()
        .post(formData, "/grouppurchase/updateProductCollection",
            (Map<String, dynamic> data) {
      isUpdate = true;
    }, errorCallBack);
  ...
  //收藏好价优惠
  Future<bool> updateGoodPriceCollection(GoodPiceModel goodPiceModel, int uid,
    ...
    await NetUtil.getInstance()
        .post(formData, "/grouppurchase/updateGoodPriceCollection",
            (Map<String, dynamic> data) {
      isUpdate = true;
    }, errorCallBack);
  ...
  Future<List<GoodPiceModel>> getUserGoodPriceCollectionInfo(
    ...
    await NetUtil.getInstance()
        .get("/grouppurchase/getUserGoodPriceCollectionInfo",
            (Map<String, dynamic> data) {
      if (data["data"] != null) {
        for (int i = 0; i < data["data"].length; i++) {
  ...
  Future<bool> delCollection(
    ...
    await NetUtil.getInstance()
        .post(formData, "/grouppurchase/delProductCollection",
            (Map<String, dynamic> data) {
      isUpdate = true;
    }, errorCallBack);
  ...
  Future<bool> delGoodPriceCollection(
      String goodpriceid, int uid, String token, Function errorCallBack) async {
    bool isUpdate = false;
    FormData formData = FormData.fromMap({
      "token": token,
    ...
    await NetUtil.getInstance()
        .post(formData, "/grouppurchase/delGoodPriceCollection",
            (Map<String, dynamic> data) {
      isUpdate = true;
    }, errorCallBack);
  ...
  Future<void> getUserGoodPriceCollection(int uid, String token) async {
    ...
    if (count <= 0) {
      ...
      await NetUtil.getInstance()
          .post(formData, "/grouppurchase/getUserGoodPriceCollectionInfo",
              (Map<String, dynamic> data) async {
        if (data != null) {
          if (data["data"] != null) {
            for (int i = 0; i < data["data"].length; i++) {
              GoodPiceModel goodPiceModel =
                  GoodPiceModel.fromJson(data["data"][i]);
              await imhelper.delGoodPriceCollectionState(
                  goodPiceModel.goodpriceid, uid);
              await imhelper.saveGoodPriceCollectionState(goodPiceModel, uid);
            }
          }
        }
  ...
  Future<bool> updateCommentLike(int commentid, int uid, String token,
      int likeuid, String goodpriceid, Function errorCallBack) async {
    bool isUpdate = false;
    FormData formData = FormData.fromMap({
      "token": token,
      "commentid": commentid,
    ...
    await NetUtil.getInstance()
        .post(formData, "/grouppurchase/updateCommentLike",
            (Map<String, dynamic> data) {
      isUpdate = true;
    }, errorCallBack);
    if (isUpdate) {
  ...
  Future<List<Comment>> getCommentList(
      String goodpriceid, int uid, Function errorCallBack) async {
    List<Comment> listComments = [];
    await NetUtil.getInstance().get("/grouppurchase/getcomment",
        (Map<String, dynamic> data) {
      if (data["data"] != null) {
        for (int i = 0; i < data["data"].length; i++) {
  ...
  //取消留言
  Future<bool> delMessage(String token, int uid, int commentid,
      String goodpriceid, Function errorCallBack) async {
    bool isUpdate = false;
    FormData formData = FormData.fromMap({
      "token": token,
      "commentid": commentid,
  ...
  //取消留言里的回复
  Future<bool> delMessageReply(String token, int uid, int replyid,
      String goodpriceid, Function errorCallBack) async {
    bool isUpdate = false;
    FormData formData = FormData.fromMap({
      "token": token,
  ...
  Future<bool> delCommentLike(int commentid, int uid, String token, int likeuid,
    ...
    await NetUtil.getInstance().post(formData, "/grouppurchase/delCommentLike",
        (Map<String, dynamic> data) {
      isUpdate = true;
    }, errorCallBack);
    if (isUpdate) {
  ...
  Future<bool> updateGoodPriceLike(
    ...
    await NetUtil.getInstance()
        .post(formData, "/grouppurchase/updateGoodPriceLike",
            (Map<String, dynamic> data) {
      isUpdate = true;
    }, errorCallBack);
    if (isUpdate) {
  ...
  Future<bool> delGoodPriceLike(
    ...
    await NetUtil.getInstance()
        .post(formData, "/grouppurchase/updateCancelLike",
            (Map<String, dynamic> data) {
      isUpdate = true;
    }, errorCallBack);
    if (isUpdate) {
  ...
  Future<bool> updateCancelUnLike(
    ...
    await NetUtil.getInstance()
        .post(formData, "/grouppurchase/updateCancelUnLike",
            (Map<String, dynamic> data) {
      isUpdate = true;
    }, errorCallBack);
    if (isUpdate) {
  ...
  Future<GoodPiceModel?> getGoodPriceInfo(String goodpriceid) async {
    GoodPiceModel? goodPiceModel;
    await NetUtil.getInstance().get("/grouppurchase/getGoodPriceInfo",
        (Map<String, dynamic> data) {
  ...
  //创建团购订单
  Future<String> createGPOrder(String actid, int uid, String token, int touid,
      Function errorCallBack) async {
    String orderid = "";
    FormData formData = FormData.fromMap(
        {"token": token, "actid": actid, "uid": uid, "touid": touid});
  ...
  //参加活动
  Future<Activity?> joinGPActivity(String actid, int uid, String token,
  ...
  Future<bool> clientPaySuccess(
      String orderid, int uid, String token, Function errorCallBack) async {
    bool isUpdate = false;
    FormData formData = FormData.fromMap({
      "token": token,
      "orderid": orderid,
  ...
  Future<List<Activity>> getActivityList(String goodpriceid) async {
    ...
    await NetUtil.getInstance().get("/grouppurchase/getActivityList",
        (Map<String, dynamic> data) {
      if (data["data"] != null) {
        for (int i = 0; i < data["data"].length; i++) {
  ...
  //通知服务器客户端支付成功
  Future<bool> updategoodpricestatus(int uid, String token, String goodpriceid,
      int status, String msg, String tag, Function errorCallBack) async {
    bool isUpdate = false;
    FormData formData = FormData.fromMap({
      "goodpriceid": goodpriceid,
      "uid": uid,
    ...
    await NetUtil.getInstance()
        .post(formData, "/grouppurchase/updategoodpricestatus",
            (Map<String, dynamic> data) {
      isUpdate = true;
    }, errorCallBack);
  ...
  Future<bool> createGoodPrice(
    ...
    await NetUtil.getInstance().post(formData, "/grouppurchase/createGoodPrice",
        (Map<String, dynamic> data) {
  ...
  Future<bool> updateGoodPrice(
    ...
    await NetUtil.getInstance().post(formData, "/grouppurchase/updateGoodPrice",
        (Map<String, dynamic> data) {
      goodpriceid = data["data"];
    }, errorCallBack);
    if (goodpriceid != null && goodpriceid.isNotEmpty) {
  ...
  Future<List<GoodPiceModel>> getGoodPriceList() async {
    List<GoodPiceModel> goodPrices = [];
    await NetUtil.getInstance().get("/grouppurchase/getSysGoodPriceCheck",
        (Map<String, dynamic> data) {
      if (data["data"] != null) {
        for (int i = 0; i < data["data"].length; i++) {
  ...
  Future<List<GoodPiceModel>> getMyGoodPricePendingList() async {
    List<GoodPiceModel> goodPrices = [];
    await NetUtil.getInstance().get("/grouppurchase/getMyGoodPricePendingList",
        (Map<String, dynamic> data) {
      if (data["data"] != null) {
        for (int i = 0; i < data["data"].length; i++) {
          goodPrices.add(GoodPiceModel.fromJson(data["data"][i]));
  ...
  Future<List<GoodPiceModel>> getMyGoodPriceFinishList() async {
    List<GoodPiceModel> goodPrices = [];
    await NetUtil.getInstance().get("/grouppurchase/getMyGoodPriceFinishList",
        (Map<String, dynamic> data) {
      if (data["data"] != null) {
        for (int i = 0; i < data["data"].length; i++) {
          goodPrices.add(GoodPiceModel.fromJson(data["data"][i]));
  ...
  Future<bool> delMyGoodPrice(
      String goodpriceid, Function errorCallBack) async {
    bool ret = false;
    await NetUtil.getInstance().get("/grouppurchase/delMyGoodPrice",
        (Map<String, dynamic> data) {
      if (data["data"] != null) {
        ret = true;
      }
  ...
  Future<List<GoodPiceModel>> getRecommendGoodPriceList(
      int type, int currentIndex) async {
    List<GoodPiceModel> goodpicemodels = [];
    await NetUtil.getInstance().get("/grouppurchase/getRecommendGoodPriceList",
        (Map<String, dynamic> data) {
      if (data["data"] != null) {
        for (int i = 0; i < data["data"].length; i++) {
  ...
  Future<List<Skuspecs>> getProductSpecsList(String goodpriceid) async {
    ...
    await NetUtil.getInstance().get("/grouppurchase/getSkuStockList",
        (Map<String, dynamic> data) {
      if (data["data"] != null) {
        for (int i = 0; i < data["data"].length; i++) {
  ...
  Future<List<EvaluateActivity>> getEvaluateGoodPriceList(
      String goodpriceid, int currentIndex, Function errorCallBack) async {
    ...
    await NetUtil.getInstance()
        .post(formData, "/grouppurchase/getEvaluateGoodPriceList",
            (Map<String, dynamic> data) {
      for (int i = 0; i < data["data"].length; i++) {
    ...
    if (evaluateActivities != null &&
        evaluateActivities.length > 0 &&
