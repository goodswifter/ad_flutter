...
class ActivityService {
  ...
  Future<Activity?> getActivityInfo(
      String actid, Function errorCallBack) async {
    Activity? activity;
    int uid = 0;
    if (Global.profile.user != null) {
      uid = Global.profile.user!.uid;
    }
    await NetUtil.getInstance().get("/Activity/getActivity",
        (Map<String, dynamic> data) {
      if (data["data"] != null) {
        activity = Activity.fromJson(data["data"]);
      }
  ...
  Future<Activity?> getActivityMember(
    ...
    await NetUtil.getInstance().get("/Activity/getActivityMember",
        (Map<String, dynamic> data) {
      if (data["data"] != null) {
        activity = Activity.fromJson(data["data"]);
      }
  ...
  Future<Activity?> getActivityAndPendingOrder(
      String actid, int uid, String token, Function errorCallBack) async {
    Activity? activity;
    int uid = 0;
    if (Global.profile.user != null) {
      uid = Global.profile.user!.uid;
    }
    await NetUtil.getInstance().get("/Activity/getActivityAndPendingOrder",
        (Map<String, dynamic> data) {
      if (data["data"] != null) {
        activity = Activity.fromJson(data["data"]);
      }
  ...
  Future<List<Activity>> getActivityListByUpdateTime(int currentIndex) async {
    ...
    await NetUtil.getInstance().get("/Activity/getActivityListByUpdateTime",
        (Map<String, dynamic> data) {
      if (data["data"] != null) {
  ...
  Future<List<Activity>> getActivityListByUser(
      int currentIndex, int uid) async {
    List<Activity> activityList = [];
    await NetUtil.getInstance().get("/Activity/getActivityListByUser",
        (Map<String, dynamic> data) {
      if (data["data"] != null) {
        for (int i = 0; i < data["data"].length; i++) {
          activityList.add(Activity.fromJson(data["data"][i]));
  ...
  Future<List<Activity>> getActivityListByUserCount5(
      int currentIndex, int uid, String token) async {
    List<Activity> activityList = [];
    await NetUtil.getInstance().get("/Activity/getActivityListByUserCount5",
        (Map<String, dynamic> data) {
      if (data["data"] != null) {
        for (int i = 0; i < data["data"].length; i++) {
          activityList.add(Activity.fromJson(data["data"][i]));
  ...
  Future<List<Activity>> getAllActivityListByUserCount5(
      int currentIndex, int uid, String token) async {
    List<Activity> activityList = [];
    await NetUtil.getInstance().get("/Activity/getAllActivityListByUserCount5",
        (Map<String, dynamic> data) {
      if (data["data"] != null) {
        for (int i = 0; i < data["data"].length; i++) {
          activityList.add(Activity.fromJson(data["data"][i]));
  ...
  Future<List<Activity>> getActivityFinishListByUserCount5(
      int currentIndex, int uid, String token) async {
    List<Activity> activityList = [];
    await NetUtil.getInstance()
        .get("/Activity/getActivityFinishListByUserCount5",
            (Map<String, dynamic> data) {
      if (data["data"] != null) {
        for (int i = 0; i < data["data"].length; i++) {
          activityList.add(Activity.fromJson(data["data"][i]));
  ...
  Future<List<Activity>> getJoinActivityListByUser(
      int currentIndex, int uid, String token) async {
    List<Activity> activityList = [];
    await NetUtil.getInstance().get("/Activity/getJoinActivityListByUser",
        (Map<String, dynamic> data) {
      if (data["data"] != null) {
        for (int i = 0; i < data["data"].length; i++) {
          activityList.add(Activity.fromJson(data["data"][i]));
  ...
  Future<List<Activity>> getJoinActivityListByUserCount5(
      int currentIndex, int uid, String token) async {
    List<Activity> activityList = [];
    await NetUtil.getInstance().get("/Activity/getJoinActivityListByUserCount5",
        (Map<String, dynamic> data) {
      if (data["data"] != null) {
        for (int i = 0; i < data["data"].length; i++) {
          activityList.add(Activity.fromJson(data["data"][i]));
  ...
  Future<List<Activity>> getJoinActivityFinishListByUserCount5(
    ...
    List<Activity> activityList = [];
    await NetUtil.getInstance()
        .get("/Activity/getJoinActivityFinishListByUserCount5",
            (Map<String, dynamic> data) {
      if (data["data"] != null) {
        for (int i = 0; i < data["data"].length; i++) {
          activityList.add(Activity.fromJson(data["data"][i]));
  ...
  Future<List<Activity>> getALLJoinActivityListByUserCount5(
    ...
    List<Activity> activityList = [];
    await NetUtil.getInstance()
        .get("/Activity/getALLJoinActivityListByUserCount5",
            (Map<String, dynamic> data) {
      if (data["data"] != null) {
        for (int i = 0; i < data["data"].length; i++) {
          activityList.add(Activity.fromJson(data["data"][i]));
  ...
  Future<List<Activity>> getCollectionActivityListByUser(
      int currentIndex, int uid, String token) async {
    List<Activity> activityList = [];
    await NetUtil.getInstance().get("/Activity/getCollectionActivityListByUser",
        (Map<String, dynamic> data) {
      if (data["data"] != null) {
        for (int i = 0; i < data["data"].length; i++) {
          activityList.add(Activity.fromJson(data["data"][i]));
  ...
  Future<List<Activity>> getCollectionActivityListByUserCount5(
    ...
    List<Activity> activityList = [];
    await NetUtil.getInstance()
        .get("/Activity/getCollectionActivityListByUserCount5",
            (Map<String, dynamic> data) {
      if (data["data"] != null) {
        for (int i = 0; i < data["data"].length; i++) {
          activityList.add(Activity.fromJson(data["data"][i]));
  ...
  Future<List<Activity>> getActivityListByCity(
      int currentIndex, String citycode) async {
    List<Activity> activityList = [];
    await NetUtil.getInstance().get("/Activity/getActivityListByCity",
        (Map<String, dynamic> data) {
      if (data["data"] != null) {
        for (int i = 0; i < data["data"].length; i++) {
          activityList.add(Activity.fromJson(data["data"][i]));
  ...
  Future<List<Activity>> getActivityListByFollow(
      int currentIndex, List<User> users) async {
    List<Activity> activityList = [];
    String ids = "";
    ...
    await NetUtil.getInstance()
        .post(formData, "/Activity/getActivityFollowList",
  ...
  Future<List<Activity>> getActivityListByCid(String cid) async {
    List<Activity> activityList = [];
    await NetUtil.getInstance().get("/Activity/selectActivityByCid",
        (Map<String, dynamic> data) {
      if (data["data"] != null) {
        for (int i = 0; i < data["data"].length; i++) {
          activityList.add(Activity.fromJson(data["data"][i]));
...
//    },params: {"actid": actid.toString(), "uid": uid.toString()}, errorCallBack: errorResponse);
  ...
  Future<void> getUserLikeSuggest(int uid, String token) async {
    ...
    if (count <= 0) {
      ...
      await NetUtil.getInstance().post(formData, "/Activity/getUserLikeSuggest",
          (Map<String, dynamic> data) async {
        if (data != null) {
          if (data["data"] != null) {
            for (int i = 0; i < data["data"].length; i++) {
  ...
  Future<void> getUserLikeMoment(int uid, String token) async {
    ...
    if (count <= 0) {
      ...
      await NetUtil.getInstance().post(formData, "/Activity/getUserLikeMoment",
          (Map<String, dynamic> data) async {
        if (data != null) {
          if (data["data"] != null) {
            for (int i = 0; i < data["data"].length; i++) {
  ...
  Future<void> getUserComnnentLike(
      int uid, String token, int likecomment, int likeevaluate) async {
    ...
    if (commentcount <= 0 && likecomment > 0) {
      ...
      await NetUtil.getInstance()
          .post(formData, "/Activity/getUserComnnentLike",
              (Map<String, dynamic> data) async {
        if (data != null) {
          if (data["data"] != null) {
            for (int i = 0; i < data["data"].length; i++) {
    ...
    if (evaluatecount <= 0 && likeevaluate > 0) {
      ...
      await NetUtil.getInstance()
          .post(formData1, "/Activity/getUserEvaluateLike",
              (Map<String, dynamic> data) async {
        if (data != null) {
          if (data["data"] != null) {
            for (int i = 0; i < data["data"].length; i++) {
  ...
  Future<void> getUserGoodPriceComnnentLike(
      int uid, String token, int likecomment) async {
    ...
    if (commentcount <= 0 && likecomment > 0) {
      ...
      await NetUtil.getInstance()
          .post(formData, "/grouppurchase/getUserGoodPriceComnnentLike",
              (Map<String, dynamic> data) async {
        if (data != null) {
          if (data["data"] != null) {
            for (int i = 0; i < data["data"].length; i++) {
  ...
  Future<void> getUserBugAndSuggestAndMomentComnnentLike(int uid, String token,
    ...
    int bugcommentcount =
        await imhelper.selBugAndSuggestCommentCountState(uid, 0);
    int suggestcommentcount =
        await imhelper.selBugAndSuggestCommentCountState(uid, 1);
    int momentcommentcount =
        await imhelper.selBugAndSuggestCommentCountState(uid, 2);
    ...
    if (bugcommentcount <= 0 && bugcommentlike > 0) {
      ...
      await NetUtil.getInstance()
          .post(formData, "/Activity/getUserBugComnnentLike",
              (Map<String, dynamic> data) async {
        if (data != null) {
          if (data["data"] != null) {
            for (int i = 0; i < data["data"].length; i++) {
    ...
    if (suggestcommentcount <= 0 && suggestcommentlike > 0) {
      ...
      await NetUtil.getInstance()
          .post(formData1, "/Activity/getUserSuggestComnnentLike",
              (Map<String, dynamic> data) async {
        if (data != null) {
          if (data["data"] != null) {
            for (int i = 0; i < data["data"].length; i++) {
    ...
    if (momentcommentcount <= 0 && momentcommentlike > 0) {
      ...
      await NetUtil.getInstance()
          .post(formData1, "/Activity/getUserMomentCommentLike",
              (Map<String, dynamic> data) async {
        if (data != null) {
          if (data["data"] != null) {
            for (int i = 0; i < data["data"].length; i++) {
  ...
  Future<bool> updateCollection(
      Activity activity, int uid, String token, Function errorCallBack) async {
    bool isUpdate = false;
    FormData formData = FormData.fromMap({
      "token": token,
  ...
  //取消留言
  Future<bool> delMessage(String token, int uid, int commentid, String actid,
      Function errorCallBack) async {
    bool isUpdate = false;
    FormData formData = FormData.fromMap({
      "token": token,
  ...
  //取消留言里的回复
  Future<bool> delMessageReply(String token, int uid, int replyid, String actid,
      Function errorCallBack) async {
    bool isUpdate = false;
    FormData formData = FormData.fromMap({
      "token": token,
  ...
  Future<List<Comment>> getCommentList(
      String actid, int uid, Function errorCallBack) async {
    List<Comment> listComments = [];
    await NetUtil.getInstance().get("/Activity/getcomment",
        (Map<String, dynamic> data) {
      if (data["data"] != null) {
        for (int i = 0; i < data["data"].length; i++) {
    ...
    if (listComments != null && listComments.length > 0) {
      for (int i = 0; i < listComments.length; i++) {
        List<String> actid = await imhelper.selActivityCommentState(
            listComments[i].commentid.toString(), uid);
        if (actid.length > 0)
  ...
  //点赞
  Future<bool> updateCommentLike(int commentid, int uid, String token,
      int likeuid, String actid, Function errorCallBack) async {
    bool isUpdate = false;
    FormData formData = FormData.fromMap({
      "token": token,
      "commentid": commentid,
  ...
  //取消点赞
  Future<bool> delCommentLike(int commentid, int uid, String token, int likeuid,
      Function errorCallBack) async {
    bool isUpdate = false;
    FormData formData = FormData.fromMap({
      "token": token,
  ...
  //点赞
  Future<bool> updateEvaluateLike(int evaluateid, int uid, String token,
      int likeuid, String actid, Function errorCallBack) async {
    bool isUpdate = false;
    FormData formData = FormData.fromMap({
      "token": token,
  ...
  //取消点赞
  Future<bool> delEvaluateLike(int evaluateid, int uid, String token,
      int likeuid, Function errorCallBack) async {
    bool isUpdate = false;
    FormData formData = FormData.fromMap({
      "token": token,
      "evaluateid": evaluateid,
  ...
  //编辑活动
  Future<bool> updateActivity(String actid, int uid, String token,
      String content, Function errorCallBack) async {
    bool isUpdate = false;
    FormData formData = FormData.fromMap(
        {"token": token, "actid": actid, "uid": uid, "content": content});
  ...
  //更新活动状态
  Future<bool> updateActivityStatus(String actid, int uid, String token,
      int status, Function errorCallBack) async {
    bool isUpdate = false;
    FormData formData = FormData.fromMap(
        {"token": token, "actid": actid, "uid": uid, "status": status});
    await NetUtil.getInstance().post(formData, "/Activity/updateActivityStatus",
        (Map<String, dynamic> data) {
      isUpdate = true;
    }, errorCallBack);
    return isUpdate;
  ...
  Future<bool> updateActivityStatusEnd(
    ...
    await NetUtil.getInstance()
        .post(formData, "/Activity/updateActivityStatusEnd",
            (Map<String, dynamic> data) {
      isUpdate = true;
    }, errorCallBack);
    return isUpdate;
  ...
  //参加活动
  Future<GroupRelation?> joinActivity(String actid, int uid, String token,
      String username, String sex, Function errorCallBack) async {
  ...
  Future<GroupRelation?> getGroupConversation(
    ...
    GroupRelation? groupRelation;
    FormData formData =
        FormData.fromMap({"token": token, "timeline_id": actid, "uid": uid});
    await NetUtil.getInstance().post(formData, "/Activity/getGroupConversation",
        (Map<String, dynamic> data) {
      if (data['data'] != null)
        groupRelation = GroupRelation.fromJson(data['data']);
    }, errorCallBack);
  ...
  Future<CommentReply?> getReply(int replyid, Function errorCallBack) async {
    ...
    await NetUtil.getInstance().get("/Activity/getReply",
        (Map<String, dynamic> data) {
      if (data["data"] != null) {
  ...
  Future<UserNotice?> syncUserNotice(
      int uid, String token, Function errorCallBack) async {
  ...
  //下载未读数据到本地存储
  Future<void> saveLocalStore(UserNotice userNotice, String token, int uid,
      Function errorCallBack) async {
    ///同步数据分为
    ...
    if (userNotice.unevaluate_activity >= 0) {
      await syncOrderUnEvaluateUpdateFun(
          uid, userNotice.unevaluate_activity, errorCallBack);
    }
    ...
    if (userNotice.unread_orderpending >= 0) {
      ...
      await syncOrderUpdateFun(
          uid, 0, userNotice.unread_orderpending, token, errorCallBack);
    }

    if (userNotice.unread_orderfinish >= 0) {
      await syncOrderUpdateFun(
          uid, 1, userNotice.unread_orderfinish, token, errorCallBack);
    }
  }

  Future<void> syncCommentFun(
      UserNotice userNotice, uid, token, Function errorCallBack) async {
    //读取消息是否成功  issuccess
    ...
    ///服务器获取的已读数据和本地缓存的对比，使用最新的
    var temsequence_id = await imhelper.getMaxReplyid(ReplyMsgType.commentmsg);
  ...
  Future<void> syncBugCommentFun(
    ...
    ///服务器获取的已读数据和本地缓存的对比，使用最新的
    var temsequence_id =
        await imhelper.getMaxReplyid(ReplyMsgType.bugcommentmsg);
    ...
    if (issuccess) {
      await postReadMessage(
          ReplyMsgType.bugcommentmsg, uid, token, errorCallBack);
    }
  }
  ...
  Future<void> syncSuggestCommentFun(
    ...
    ///服务器获取的已读数据和本地缓存的对比，使用最新的
    var temsequence_id =
        await imhelper.getMaxReplyid(ReplyMsgType.suggestcommentmsg);

    ///如果本地已储存的数据大于服务器则使用本地最新数据id
    if (temsequence_id != null &&
        temsequence_id > userNotice.read_suggestcomment)
      sequence_id = temsequence_id;
    FormData formData = FormData.fromMap({
      "uid": uid,
      "token": token,
    ...
    if (issuccess) {
      await postReadMessage(
          ReplyMsgType.suggestcommentmsg, uid, token, errorCallBack);
    }
  }
  ...
  Future<void> syncMomentCommentFun(
    ...
    ///服务器获取的已读数据和本地缓存的对比，使用最新的
    var temsequence_id =
        await imhelper.getMaxReplyid(ReplyMsgType.momentcommentmsg);

    ///如果本地已储存的数据大于服务器则使用本地最新数据id
    if (temsequence_id != null &&
        temsequence_id > userNotice.read_momentcomment)
      sequence_id = temsequence_id;
    FormData formData = FormData.fromMap({
      "uid": uid,
      "token": token,
    ...
    if (issuccess) {
      await postReadMessage(
          ReplyMsgType.momentcommentmsg, uid, token, errorCallBack);
    }
  }
  ...
  Future<void> syncGoodPriceCommentFun(
    ...
    ///服务器获取的已读数据和本地缓存的对比，使用最新的
    var temsequence_id =
        await imhelper.getMaxReplyid(ReplyMsgType.goodpricecommentmsg);

    ///如果本地已储存的数据大于服务器则使用本地最新数据id
    if (temsequence_id != null &&
        temsequence_id > userNotice.read_goodpricecommentindex)
      sequence_id = temsequence_id;
    FormData formData = FormData.fromMap({
      "uid": uid,
      "token": token,
    ...
    ///通过自增的已读ID获取未读消息
    await NetUtil.getInstance()
        .post(formData, "/grouppurchase/getNewCommentList",
            (Map<String, dynamic> data) {
      if (data["data"] != null) {
        issuccess = true;
        for (int i = 0; i < data["data"].length; i++) {
    ...
    if (commentReplys != null && commentReplys.isNotEmpty) {
      await imhelper.saveReplys(
          commentReplys, ReplyMsgType.goodpricecommentmsg);
    }
    if (issuccess) {
      await postReadMessage(
          ReplyMsgType.goodpricecommentmsg, uid, token, errorCallBack);
    }
  }
  ...
  Future<void> syncActivityCommentLikeFun(
    ...
    ///通过自增的已读ID获取未读消息
    await NetUtil.getInstance()
        .post(formData, "/Activity/getActivityCommentLikeList",
            (Map<String, dynamic> data) {
      if (data["data"] != null) {
        issuccess = true;
        for (int i = 0; i < data["data"].length; i++) {
  ...
  Future<void> syncGoodPriceCommentLikeFun(
    ...
    ///如果本地已储存的数据大于服务器则使用本地最新数据id
    if (temsequence_id != null &&
        temsequence_id > userNotice.read_goodpricecommentlike)
      sequence_id = temsequence_id;
    FormData formData = FormData.fromMap({
      "uid": uid,
      "token": token,
    ...
    ///通过自增的已读ID获取未读消息
    await NetUtil.getInstance()
        .post(formData, "/grouppurchase/getGoodPriceCommentLikeList",
            (Map<String, dynamic> data) {
      if (data["data"] != null) {
        issuccess = true;
        for (int i = 0; i < data["data"].length; i++) {
  ...
  Future<void> syncBugCommentLikeFun(
    ...
    ///如果本地已储存的数据大于服务器则使用本地最新数据id
    if (temsequence_id != null &&
        temsequence_id > userNotice.read_bugcommentlike)
      sequence_id = temsequence_id;
    FormData formData = FormData.fromMap({
      "uid": uid,
      "token": token,
    ...
    ///通过自增的已读ID获取未读消息
    await NetUtil.getInstance()
        .post(formData, "/Activity/getBugCommentLikeList",
            (Map<String, dynamic> data) {
      if (data["data"] != null) {
        issuccess = true;
        for (int i = 0; i < data["data"].length; i++) {
  ...
  Future<void> syncSuggestCommentLikeFun(
    ...
    ///如果本地已储存的数据大于服务器则使用本地最新数据id
    if (temsequence_id != null &&
        temsequence_id > userNotice.read_suggestcommentlike)
      sequence_id = temsequence_id;
    FormData formData = FormData.fromMap({
      "uid": uid,
      "token": token,
    ...
    ///通过自增的已读ID获取未读消息
    await NetUtil.getInstance()
        .post(formData, "/Activity/getSuggestCommentLikeList",
            (Map<String, dynamic> data) {
      if (data["data"] != null) {
        issuccess = true;
        for (int i = 0; i < data["data"].length; i++) {
  ...
  Future<void> syncMomentCommentLikeFun(
    ...
    ///如果本地已储存的数据大于服务器则使用本地最新数据id
    if (temsequence_id != null &&
        temsequence_id > userNotice.read_momentcommentlike)
      sequence_id = temsequence_id;
    FormData formData = FormData.fromMap({
      "uid": uid,
      "token": token,
    ...
    ///通过自增的已读ID获取未读消息
    await NetUtil.getInstance()
        .post(formData, "/Activity/getMomentCommentLikeList",
            (Map<String, dynamic> data) {
      if (data["data"] != null) {
        issuccess = true;
        for (int i = 0; i < data["data"].length; i++) {
  ...
  Future<void> syncFollowFun(
    ...
    if (issuccess) {
      await postReadMessage(
          ReplyMsgType.newfollowed, uid, token, errorCallBack);
    }
  }
  ...
  Future<void> syncReplyFun(
    ...
    ///服务器获取的已读数据和本地缓存的对比，使用最新的
    var temsequence_id = await imhelper.getMaxReplyid(ReplyMsgType.replymsg);
  ...
  Future<void> syncGoodPriceReplyFun(
    ...
    ///服务器获取的已读数据和本地缓存的对比，使用最新的
    var temsequence_id =
        await imhelper.getMaxReplyid(ReplyMsgType.goodpricereplymsg);

    ///如果本地已储存的数据大于服务器则使用本地最新数据id
    if (temsequence_id != null &&
        temsequence_id > userNotice.read_goodpricereplyindex)
      sequence_id = temsequence_id;
    FormData formData = FormData.fromMap({
      "uid": uid,
      "token": token,
    ...
    ///通过自增的已读ID获取未读消息
    await NetUtil.getInstance()
        .post(formData, "/grouppurchase/getCommentReplyList",
            (Map<String, dynamic> data) {
      if (data["data"] != null) {
        issuccess = true;
        for (int i = 0; i < data["data"].length; i++) {
    ...
    if (commentReplys != null && commentReplys.isNotEmpty) {
      int count = await imhelper.saveReplys(
          commentReplys, ReplyMsgType.goodpricereplymsg);
    }
    if (issuccess) {
      await postReadMessage(
          ReplyMsgType.goodpricereplymsg, uid, token, errorCallBack);
    }
  }
  ...
  Future<void> syncBugReplyFun(
    ...
    ///服务器获取的已读数据和本地缓存的对比，使用最新的
    var temsequence_id = await imhelper.getMaxReplyid(ReplyMsgType.bugreplymsg);
    ...
    if (issuccess) {
      await postReadMessage(
          ReplyMsgType.bugreplymsg, uid, token, errorCallBack);
    }
  }
  ...
  Future<void> syncSuggestReplyFun(
    ...
    ///服务器获取的已读数据和本地缓存的对比，使用最新的
    var temsequence_id =
        await imhelper.getMaxReplyid(ReplyMsgType.suggestreplymsg);
    ...
    if (commentReplys != null && commentReplys.isNotEmpty) {
      int count = await imhelper.saveReplys(
          commentReplys, ReplyMsgType.suggestreplymsg);
    }
    if (issuccess) {
      await postReadMessage(
          ReplyMsgType.suggestreplymsg, uid, token, errorCallBack);
    }
  }
  ...
  Future<void> syncMomentReplyFun(
    ...
    ///服务器获取的已读数据和本地缓存的对比，使用最新的
    var temsequence_id =
        await imhelper.getMaxReplyid(ReplyMsgType.momentreplymsg);

    ///如果本地已储存的数据大于服务器则使用本地最新数据id
    if (temsequence_id != null &&
        temsequence_id > userNotice.unread_momentreply)
      sequence_id = temsequence_id;
    FormData formData = FormData.fromMap({
      "uid": uid,
      "token": token,
    ...
    if (issuccess) {
      await postReadMessage(
          ReplyMsgType.momentreplymsg, uid, token, errorCallBack);
    }
  }
  ...
  Future<void> syncSysNoticeFun(
    ...
    ///服务器获取的已读数据和本地缓存的对比，使用最新的
    var temsequence_id = await imhelper.getMaxReplyid(ReplyMsgType.sysnotice);

    ///如果本地已储存的数据大于服务器则使用本地最新数据id
    if (temsequence_id != null &&
        temsequence_id > userNotice.read_sysnoticeindex)
      sequence_id = temsequence_id;
    FormData formData = FormData.fromMap({
      "uid": uid,
      "token": token,
  ...
  Future<void> syncSharedFun(
    ...
    ///如果本地已储存的数据大于服务器则使用本地最新数据id
    if (id != null && id > userNotice.read_shared) sequence_id = id;
    FormData formData = FormData.fromMap({
      "uid": uid,
      "token": token,
    ...
    if (issuccess) {
      await postReadMessage(
          ReplyMsgType.sharedReaded, uid, token, errorCallBack);
    }
  }
  ...
  Future<List<Order>> getUnEvaluateOrderList(
    ...
    ///获取未评论活动
    await NetUtil.getInstance()
        .post(formData, "/Activity/getUnEvaluateOrderList",
            (Map<String, dynamic> data) {
      if (data["data"] != null) {
        for (int i = 0; i < data["data"].length; i++) {
  ...
  Future<void> syncUnActivityEvaluateFun(
    ...
    ///判断服务器未评论活动是否大于本地
    List<ActivityEvaluate>? activitys =
        await imhelper.getUnEvaluateActivity(0, 10000, 0);
    ...
    if ((activitys != null && userNotice.unevaluate_activity > 0) ||
      ...
      FormData formData =
          FormData.fromMap({"uid": uid, "token": token, "readindex": 0});

      ///获取未评论活动
      await NetUtil.getInstance()
          .post(formData, "/Activity/getUnActvityEvaluateList",
              (Map<String, dynamic> data) {
        if (data["data"] != null) {
          issuccess = true;
          for (int i = 0; i < data["data"].length; i++) {
      ...
      if (activityEvaluates != null && activityEvaluates.length > 0) {
        int count = await imhelper.saveUnEvaluateActivity(
            activityEvaluates, Global.profile.user!.uid);
      }
      if (issuccess) {
        await postReadMessage(
            ReplyMsgType.evaluateactivity, uid, token, errorCallBack);
      }
    }
  }
  ...
  Future<void> syncUnActivityEvaluateFunReadIndex(
    ...
    ///如果本地已储存的数据大于服务器则使用本地最新数据id
    if (id != null && id > userNotice.evaluate_activity) sequence_id = id;
    FormData formData = FormData.fromMap({
      "uid": uid,
      "token": token,
      "readindex": sequence_id, //服务器已读的
  ...
  Future<void> syncEvaluateFun(
    ...
    ///服务器获取的已读数据和本地缓存的对比，使用最新的
    var temsequence_id = await imhelper.getMaxReplyid(ReplyMsgType.evaluatemsg);
    ...
    if (issuccess) {
      await postReadMessage(
          ReplyMsgType.evaluatemsg, uid, token, errorCallBack);
    }
  }
  ...
  Future<void> syncEvaluateReplyFun(
    ...
    ///服务器获取的已读数据和本地缓存的对比，使用最新的
    var temsequence_id =
        await imhelper.getMaxReplyid(ReplyMsgType.evaluatereplymsg);

    ///如果本地已储存的数据大于服务器则使用本地最新数据id
    if (temsequence_id != null &&
        temsequence_id > userNotice.read_evaluatereply)
      sequence_id = temsequence_id;
    FormData formData = FormData.fromMap({
      "uid": uid,
      "token": token,
    ...
    ///通过自增的已读ID获取未读消息
    await NetUtil.getInstance()
        .post(formData, "/Activity/getNewEvaluateReplyList",
            (Map<String, dynamic> data) {
      if (data["data"] != null) {
    ...
    if (commentReplys != null && commentReplys.isNotEmpty) {
      int count = await imhelper.saveReplys(
          commentReplys, ReplyMsgType.evaluatereplymsg);
    }
    if (issuccess) {
      await postReadMessage(
          ReplyMsgType.evaluatereplymsg, uid, token, errorCallBack);
    }
  }

  Future<void> syncOrderUpdateFun(int uid, int ordertype, int count,
      String token, Function errorCallBack) async {
    await imhelper.saveUserOrder(uid, ordertype, count);
  }

  Future<void> syncOrderUnEvaluateUpdateFun(
      int uid, int count, Function errorCallBack) async {
  ...
  Future<void> syncOrderExpirationFun(
    ...
    List<GroupRelation>? grouprelationlist =
        await syncActivityRelationInit(uid, token, errorCallBack);
    await imhelper.saveGroupRelationOrderExpiration(grouprelationlist);
    await postReadMessage(
        ReplyMsgType.orderexpiration, uid, token, errorCallBack);
  }
  ...
  Future<List<GroupRelation>?> syncActivityRelationInit(
    ...
    await NetUtil.getInstance()
        .post(formData, "/IM/listActivityGroupConversationsInit",
            (Map<String, dynamic> data) {
      if (data["data"] != null) {
        grouprelationlist = [];
        for (int i = 0; i < data["data"].length; i++) {
          GroupRelation groupRelation =
              GroupRelation.fromJson((data["data"][i]));
  ...
  //已读的通知（评论，回复，系统通知）
  Future<bool> postReadMessage(ReplyMsgType replyMsgType, int uid, String token,
      Function errorCallBack) async {
    bool ret = false;
    int? readindex = null;
  ...
  Future<bool> postReadLike(
      int likeType, int uid, String token, Function errorCallBack) async {
  ...
  Future<List<SearchResult>> getRecommendSearchActivity(
    ...
    await NetUtil.getInstance()
        .post(formData, "/Activity/getRecommendSearchActivity",
            (Map<String, dynamic> data) {
      if (data["data"] != null) {
        for (int i = 0; i < data["data"].length; i++) {
  ...
  Future<List<SearchResult>> hotsearchActivity() async {
    ...
    await NetUtil.getInstance().get("/Activity/hotsearchActivity",
        (Map<String, dynamic> data) {
      if (data["data"] != null) {
        for (int i = 0; i < data["data"].length; i++) {
          SearchResult searchResult = SearchResult.fromJson(data["data"][i]);
    ...
    }, params: {}, errorCallBack: errorResponse);
  ...
  Future<List<Activity>> searchMoreLikeActivity(
    ...
    await NetUtil.getInstance()
        .post(formData, "/Activity/searchMoreLikeActivity",
            (Map<String, dynamic> data) {
      if (data["data"] != null) {
        for (int i = 0; i < data["data"].length; i++) {
          Activity searchResult = Activity.fromJson(data["data"][i]);
          if (searchResult.actid != actid) activitys.add(searchResult);
        }
      }
    }, errorCallBack);
  ...
  Future<bool> evaluateActivity(
    ...
    await NetUtil.getInstance()
        .post(formData, "/Activity/saveEvaluateInActivity",
            (Map<String, dynamic> data) {
      isUpdate = true;
    }, errorCallBack);
  ...
  Future<bool> evaluateReply(int evaluateid, int uid, String token, int touid,
      String content, Function errorCallBack) async {
    bool isUpdate = false;
  ...
  //删除并退出活动
  Future<bool> delActivityOrder(String actid, int uid, String token,
      String orderid, Function errorCallBack) async {
    bool isUpdate = false;
    FormData formData = FormData.fromMap(
        {"actid": actid, "token": token, "uid": uid, "orderid": orderid});
  ...
  //退款
  Future<bool> refundActivityOrder(String actid, int uid, String token,
      String orderid, Function errorCallBack) async {
    bool isUpdate = false;
    FormData formData = FormData.fromMap(
        {"actid": actid, "token": token, "uid": uid, "orderid": orderid});
    await NetUtil.getInstance().post(formData, "/Activity/refundActivityOrder",
        (Map<String, dynamic> data) {
      isUpdate = true;
    }, errorCallBack);
  ...
  //删除并退出活动
  Future<bool> manageDelQuiteActivity(String actid, int uid, String token,
      String uids, Function errorCallBack) async {
    bool isUpdate = false;
    ShowMessage.showCenterToast("移除成员");
    FormData formData = FormData.fromMap(
        {"actid": actid, "token": token, "uid": uid, "uids": uids});
    await NetUtil.getInstance()
        .post(formData, "/Activity/manageDelQuiteActivity",
            (Map<String, dynamic> data) {
      ShowMessage.cancel();
      isUpdate = true;
    }, errorCallBack);
  ...
  //确定转账
  Future<bool> activityFundTransfer(String actid, int uid, String token,
      String orderid, Function errorCallBack) async {
    bool isUpdate = false;
    ShowMessage.showCenterToast("付款中");
    FormData formData = FormData.fromMap(
        {"actid": actid, "token": token, "uid": uid, "orderid": orderid});
    await NetUtil.getInstance().post(formData, "/Activity/activityFundTransfer",
        (Map<String, dynamic> data) {
      ShowMessage.cancel();
      isUpdate = true;
    }, errorCallBack);
  ...
  Future<List<EvaluateActivity>> getEvaluateActivityList(
      String actid, int uid, int currentIndex, Function errorCallBack) async {
    ...
    await NetUtil.getInstance().post(formData, "/Activity/getEvaluateActivity",
        (Map<String, dynamic> data) {
      for (int i = 0; i < data["data"].length; i++) {
        EvaluateActivity evaluateActivity =
            EvaluateActivity.fromJson(data["data"][i]);
...
//        print("bbb:" + evaluateActivities[i].likenum.toString());
  ...
  Future<List<EvaluateActivityReply>> getEvaluateReplyList(
      int evaluateid, Function errorCallBack) async {
    List<EvaluateActivityReply> evaluateReplys = [];

    FormData formData = FormData.fromMap({
      "evaluateid": evaluateid,
    });
    await NetUtil.getInstance().post(formData, "/Activity/getEvaluateReplyList",
        (Map<String, dynamic> data) {
      for (int i = 0; i < data["data"].length; i++) {
        EvaluateActivityReply reply =
            EvaluateActivityReply.fromJson(data["data"][i]);
  ...
  Future<EvaluateActivity?> getEvaluateActivityByEvaluateid(
    ...
    await NetUtil.getInstance()
        .post(formData, "/Activity/getEvaluateActivityByEvaluateid",
            (Map<String, dynamic> data) {
  ...
  Future<String> updateAliPayInfo(
      int uid, String token, String auth_code, Function errorCallBack) async {
    String aliuserid = "";
    FormData formData =
        FormData.fromMap({"uid": uid, "token": token, "auth_code": auth_code});
  ...
  Future<Order?> getActivityPendingOrder(
      int uid, String token, String actid, Function errorCallBack) async {
    Order? order;
    FormData formData =
        FormData.fromMap({"uid": uid, "token": token, "actid": actid});

    await NetUtil.getInstance()
        .post(formData, "/Activity/getActivityPendingOrder",
            (Map<String, dynamic> data) {
  ...
  //获取我的举报详情
  Future<Report?> getMyReportInfo(int uid, String token, String reportid,
      int sourcetype, Function errorCallBack) async {
