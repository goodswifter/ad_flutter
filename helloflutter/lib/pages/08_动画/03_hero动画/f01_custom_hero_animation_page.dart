///
/// Author       : zhongaidong
/// Date         : 2022-03-22 17:15:40
/// Description  :
///

import 'package:flutter/material.dart';
import 'package:helloflutter/core/const/resource.dart';
import 'package:helloflutter/widgets/after_layout.dart';

class CustomHeroAnimationPage extends StatelessWidget {
  const CustomHeroAnimationPage({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('自定义Hero动画')),
...
class _CustomHeroAnimationState extends State<CustomHeroAnimation>
  ...
  Widget wChild1() {
    ...
    return GestureDetector(
      ...
      child: SizedBox(
        width: 80,
        child: ClipOval(child: Image.asset(R.ASSETS_IMAGES_AVATAR_PNG)),
      ),
    );
  }
  ...
  Widget wChild2() {
    ...
    return GestureDetector(
      ...
      child: Image.asset(R.ASSETS_IMAGES_AVATAR_PNG, width: 400),
    );
  }

  Rect _getRect(RenderAfterLayout renderAfterLayout) {
    // 我们需要获取的是AfterLayout子组件相对于Stack的Rect
    // return renderAfterLayout.offset & renderAfterLayout.size;
